...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TURING_CALLER", () => {
    process.env["TURING_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TURING_CALLER", () => {
    process.env["TURING_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TURING_CALLER", () => {
    process.env["TURING_CALLER"] = "unknown"
