...
Practical reference for the current tool-migration state in `packages/turing`.
...
Tool tests should use the existing Effect helpers in `packages/turing/test/lib/effect.ts`:
