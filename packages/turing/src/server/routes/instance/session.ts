  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Turing sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Turing session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Turing session for interacting with AI assistants and managing conversations.",
