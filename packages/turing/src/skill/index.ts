...
const TURING_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.TURING_DISABLE_EXTERNAL_SKILLS) {
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, TURING_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@turing/Skill") {}
