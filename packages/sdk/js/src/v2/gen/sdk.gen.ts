...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new TuringClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Upgrade turing
   *
   * Upgrade turing to the specified version or latest if not specified.
   */
...
export class TuringClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<TuringClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    TuringClient.__registry.set(this, args?.key)
  }
